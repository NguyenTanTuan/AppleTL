				...
				<nav class="sidebar-nav left-sidebar-menu-pro">
					<ul class="metismenu" id="menu1">
						<li class="active"><a class="has-arrow" href="index.html">
								...
								class="mini-click-non" style="color: red; font-size: 19px;">
									Account Detail</span>
						</a>
							<ul class="submenu-angle" aria-expanded="true">
								<li><a title="Product List"
									href="<c:url value="/admin/listAccount"/>"><i
										class="fa fa-female sub-icon-mg" aria-hidden="true"></i> <span
										class="mini-sub-pro" style="color: red;">Account List</span></a></li>
									...
									<div class="col-lg-6 col-md-7 col-sm-6 col-xs-12">
										<div class="header-top-menu tabl-d-n">
											<ul class="nav navbar-nav mai-top-nav">
												<li class="nav-item"><a
													href="<c:url value="/admin/listAccount"/>" class="nav-link">Home</a></li>
		...
		<div class="container">
			<div class="row" style="padding-top: 30px;">
				<div class="col-sm-12" style="text-align: center">
					<h1 style="color: orange;">Account Detail</h1>
				</div>
			</div>
			<div class="row">
				<div class="col-md-4">
					<h3>User Name: ${a.username}</h3>
				</div>
			</div>
			<div class="row">
				<div class="col-md-4">
			...
			<div class="row">
				<div class="col-sm-4">
					<h3>
						Gender:
						<c:if test="${a.gender== 'MALE' }">
						MALE
						</c:if>
						<c:if test="${a.gender=='FEMALE' }">
						FEMALE
						</c:if>
					</h3>
				</div>
			...
			<div class="row">
				<div class="col-sm-4">
					<h3>
						Status:
						<c:if test="${a.status==true }">Enable</c:if>
						<c:if test="${a.status==false }">Disable</c:if>
					</h3>
				</div>
			</div>
			<%-- <div class="row">
