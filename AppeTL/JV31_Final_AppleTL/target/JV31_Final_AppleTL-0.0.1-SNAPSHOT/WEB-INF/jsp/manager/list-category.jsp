...
<head>
<meta charset="UTF-8">
<title>Manager Category List</title>
</head>
					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						...
						<div class="product-status-wrap">
							...
							<div class="add-product">
								<a href="<c:url value="/manager/add-category"/>">Add
									Category</a>
							</div>
							...
							<table>
								...
								<c:forEach items="${category}" var="c">
									<tr>
										<td>${i}</td>
										<td style="font-size: 21px; color: red;">${c.name }</td>
										<td>${c.description }</td>

										<td>
											<button
												onclick="location.href='<c:url value="/manager/edit-category/${c.id}"/>'"
												data-toggle="tooltip" title="Edit" class=" btn btn-primary">
												<i class="fa fa-pencil-square-o" aria-hidden="true"></i>
											</button>
											<button
												onclick="location.href='<c:url value="/manager/delete-category/${c.id}"/>'"
												data-toggle="tooltip" title="Trash" class="btn btn-danger">
												<i class="fa fa-trash-o" aria-hidden="true"></i>
											</button>
											<button
												onclick="location.href='<c:url value="/manager/category-detail?id=${c.id}"/>'"
												data-toggle="tooltip" title="categoryDetail"
